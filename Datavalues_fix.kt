...
class Datavalues{
    companion object {
        val namafilm: Array<String> = arrayOf("A Star","Aquaman","Avenger: Infinity War","Birdbox",
            "Bohemian","Bumblebee","Creed","Deadpool I","Dragon","Dragon Ball","Glasss","Hunterkiller",
            "Mortal Engine","Robinhood","Spiderman I"
        )

        val detailfilm = arrayOf(
            "Seasoned musician Jackson Maine discovers — and falls in love with — struggling artist Ally. She has just about given up on her dream to make it big as a singer — until Jack coaxes her into the spotlight. But even as Allys career takes off, the personal",
        ...
        val casts = arrayOf("Bradley Cooper,Lady Gaga,Sam Elliott",
